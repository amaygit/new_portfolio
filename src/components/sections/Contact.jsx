        ...
        <FadeIn delay={0}>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-white/60 max-w-3xl mx-auto">
              ...
              want to say hi, I'm here to help. Fill out the form below or reach
              out through social media, and I'll get back to you as soon as
              possible.
            </p>
          </div>
        </FadeIn>
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <FadeIn delay={200}>
            <div className="text-2xl font-semibold text-white mb-4">
              <div>
                <h1 className="text-white/60 leading-relaxed">
                  Let's connect!
                </h1>
                <p className="">
                  I'm always open to discussing new projects, creative ideas, or
                  opportunities to be part of your visions. Feel free to reach
                  out through the contact form or connect with me on social
                  media. Let's create something amazing together and turn your
                  ideas into reality. Looking forward to hearing from you!
                </p>
              </div>
              <div className="space-y-4">
                <div className="group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 ">
                  <div className="flex items-start gap-4">
                    <div className="p-3 bg-linear-to-br from-primary/20 to-primary/20  border border-primary/30 ">
                    ...
                    <div className="flex-1">
                      ...
                      <a
                        ...
                        className="text-white visited:text-white hover:text-[#A8FF8D] no-underline transition-colors font-medium"
                      >
                        {PERSONAL_INFO.email}
                      </a>
                    </div>
                    ...
                    .map(([platform, url]) => {
                      ...
                      return Icon ? (
                        <a
                          ...
                          className="p-4 bg-white/5 rounded-xl border border-white/10 hover:bg-white/10 hover:bg-primary/50 hover:scale-110 transition-all duration-300 group"
                        >
