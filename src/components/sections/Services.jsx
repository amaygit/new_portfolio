...
const Services = () => {
  return (
    <section className="relative py-20 bg-black overflow-hidden" id="services">
        ...
        <FadeIn delay={0}>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-white/60 max-w-3xl mx-auto">
              Comprehensive solutions to transform your ideas into expectional
              artifacts. From concept to creation, I deliver results that exceed
              expectations.
            </p>
          </div>
        </FadeIn>
            ...
            return (
              <FadeIn key={service.id} delay={100 + index * 100}>
                <div className="group relative bg-white/5 border border-white/10 rounded-3xl p-8 hover:border-primary/30 transition-all duration-300 h-full min-h-[280px] flex flex-col">
                  <div className="mb-6">
                    <div className="w-16 h-16 rounded-2xl bg-primary/20 border border-primary/30 flex items-center justify-center group-hover:scale110 transition-transform duration-300">
            ...
            return (
              <FadeIn key={service.id} delay={300 + index * 100}>
                <div className="group relative bg-white/5 border border-white/10 rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 h-full">
                  <div className="mb-4">
                    <div className="w-12 h-12 rounded-lg bg-primary/20 border border-primary/30 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
